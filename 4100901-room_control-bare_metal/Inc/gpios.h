...
typedef struct {
   ...
   // volatile uint32_t AFRL; // <--- Ya activo
   // volatile uint32_t AFRH; // <--- Ya activo
...
#define B1_PIN      13U   
#define GPIO_MODE_AF   0x02  // Modo Alternativa Función
#define GPIO_TYPE_PP   0x00  // Tipo Push-Pull
